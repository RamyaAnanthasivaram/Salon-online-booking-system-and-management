    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar  ftco-navbar-light" id="ftco-navbar" style="background: deeppink;">
      ...
      <img src="..\images\fusion-parlor-high-resolution-logo-white-transparent.png" style="width:208px;">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="mystores.php" class="nav-link">My Stores</a></li>
            <li class="nav-item"><a href="staff.php" class="nav-link">Manage Staff</a></li>
            <li class="nav-item "><a href="orders.php" class="nav-link">Orders</a></li>

            <?php
                if(isset($_SESSION["owner_logged_in"]) && $_SESSION["owner_logged_in"] == true){ 

                  echo '<li class="nav-item"><a href="profile.php" class="nav-link"> Welcome, '.$_SESSION["ownername"].'</a></li>';
