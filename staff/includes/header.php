      ...
      <img src="..\images\fusion-parlor-high-resolution-logo-white-transparent.png" style="width:208px;">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="index.php" class="nav-link" style="color: #fcedff;">Home</a></li>
	         
            <?php
                if(isset($_SESSION["staff_logged_in"]) && $_SESSION["staff_logged_in"] == true){ 
                  
                  echo '<li class="nav-item"><a href="profile.php" class="nav-link"> Welcome, '.$_SESSION["staffname"].'</a></li>';
